...
#define FFMPEG_CONFIGURATION "--target-os=android --prefix=/root/shell/clang_shell/libs/ffmpeg4.2.3/arm64-v8a --enable-cross-compile --disable-runtime-cpudetect --disable-asm --arch=arm64 --cc=/root/android/ndk/android-ndk-r21/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang --cxx=/root/android/ndk/android-ndk-r21/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang++ --cross-prefix=/root/android/ndk/android-ndk-r21/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android- --extra-cflags='-I/root/shell/clang_shell/libs/libx264/arm64-v8a/include -I/root/shell/clang_shell/libs/libfdk-aac/arm64-v8a/include -I/root/shell/clang_shell/libs/openssl/arm64-v8a/include -DANDROID -Wall -fPIC' --extra-cxxflags='-DANDROID -Wall -fPIC' --extra-ldflags='-L/root/shell/clang_shell/libs/libx264/arm64-v8a/lib -L/root/shell/clang_shell/libs/libfdk-aac/arm64-v8a/lib -L/root/shell/clang_shell/libs/openssl/arm64-v8a/lib' --extra-libs=-lm --sysroot=/root/android/ndk/android-ndk-r21/toolchains/llvm/prebuilt/linux-x86_64/sysroot --enable-static --enable-shared --enable-jni --enable-mediacodec --enable-pthreads --enable-pic --disable-iconv --enable-libx264 --enable-libfdk_aac --enable-openssl --enable-gpl --enable-nonfree --disable-muxers --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=h264 --enable-muxer=avi --enable-muxer=flv --enable-muxer=hls --enable-muxer=rtp --enable-muxer=rtsp --disable-demuxers --enable-demuxer=mov --enable-demuxer=h264 --enable-demuxer=avi --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=rtp --enable-demuxer=rtsp --disable-encoders --enable-encoder=aac --enable-encoder=libfdk_aac --enable-encoder=libx264 --enable-encoder=mpeg4 --enable-encoder=mjpeg --enable-encoder=png --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=libfdk_aac --enable-decoder=h264 --enable-decoder=h264_mediacodec --enable-decoder=mpeg4 --enable-decoder=mjpeg --enable-decoder=png --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=mjpeg --enable-parser=png --disable-protocols --enable-protocol=file --enable-protocol=crypto --enable-protocol=http --enable-protocol=https --enable-protocol=tls --enable-protocol=tcp --enable-protocol=udp --enable-protocol=rtp --enable-protocol=rtmp --enable-protocol=rtmps --enable-protocol=hls --enable-zlib --enable-small --enable-postproc --disable-outdevs --disable-indevs --disable-ffprobe --disable-ffplay --disable-ffmpeg --disable-debug --disable-symver"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "/root/shell/clang_shell/libs/ffmpeg4.2.3/arm64-v8a/share/ffmpeg"
#define AVCONV_DATADIR "/root/shell/clang_shell/libs/ffmpeg4.2.3/arm64-v8a/share/ffmpeg"
