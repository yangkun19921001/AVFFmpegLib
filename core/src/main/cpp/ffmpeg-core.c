...
const char *configClassName = "com/devyk/ffmpeglib/config/Config";
...
JNINativeMethod configMethods[] = {
        {"enableNativeRedirection",      "()V",                                     (void *) Java_com_devyk_ffmpeglib_config_Config_enableNativeRedirection},
        {"disableNativeRedirection",     "()V",                                     (void *) Java_com_devyk_ffmpeglib_config_Config_disableNativeRedirection},
        {"setNativeLogLevel",            "(I)V",                                    (void *) Java_com_devyk_ffmpeglib_config_Config_setNativeLogLevel},
        {"getNativeLogLevel",            "()I",                                     (void *) Java_com_devyk_ffmpeglib_config_Config_getNativeLogLevel},
        {"getNativeFFmpegVersion",       "()Ljava/lang/String;",                    (void *) Java_com_devyk_ffmpeglib_config_Config_getNativeFFmpegVersion},
        {"getNativeVersion",             "()Ljava/lang/String;",                    (void *) Java_com_devyk_ffmpeglib_config_Config_getNativeVersion},
        {"nativeFFmpegExecute",          "(J[Ljava/lang/String;)I",                 (void *) Java_com_devyk_ffmpeglib_config_Config_nativeFFmpegExecute},
        {"nativeFFmpegCancel",           "(J)V",                                    (void *) Java_com_devyk_ffmpeglib_config_Config_nativeFFmpegCancel},
        {"nativeFFprobeExecute",         "([Ljava/lang/String;)I",                  (void *) Java_com_devyk_ffmpeglib_config_Config_nativeFFprobeExecute},
        {"registerNewNativeFFmpegPipe",  "(Ljava/lang/String;)I",                   (void *) Java_com_devyk_ffmpeglib_config_Config_registerNewNativeFFmpegPipe},
        {"getNativeBuildDate",           "()Ljava/lang/String;",                    (void *) Java_com_devyk_ffmpeglib_config_Config_getNativeBuildDate},
        {"setNativeEnvironmentVariable", "(Ljava/lang/String;Ljava/lang/String;)I", (void *) Java_com_devyk_ffmpeglib_config_Config_setNativeEnvironmentVariable},
        {"getNativeLastCommandOutput",   "()Ljava/lang/String;",                    (void *) Java_com_devyk_ffmpeglib_config_Config_getNativeLastCommandOutput},
        {"ignoreNativeSignal",           "(I)V",                                    (void *) Java_com_devyk_ffmpeglib_config_Config_ignoreNativeSignal}
};
...
Java_com_devyk_ffmpeglib_config_Config_setNativeLogLevel(JNIEnv *env, jclass object, jint level) {
...
Java_com_devyk_ffmpeglib_config_Config_getNativeLogLevel(JNIEnv *env, jclass object) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_devyk_ffmpeglib_config_Config_enableNativeRedirection(JNIEnv *env, jclass object) {
    mutexLock();
 ...
 */
JNIEXPORT void JNICALL
Java_com_devyk_ffmpeglib_config_Config_disableNativeRedirection(JNIEnv *env, jclass object) {
...
Java_com_devyk_ffmpeglib_config_Config_getNativeFFmpegVersion(JNIEnv *env, jclass object) {
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_devyk_ffmpeglib_config_Config_getNativeVersion(JNIEnv *env, jclass object) {
 ...
 */
JNIEXPORT jint JNICALL
Java_com_devyk_ffmpeglib_config_Config_nativeFFmpegExecute(JNIEnv *env, jclass object, jlong id,
 ...
 */
JNIEXPORT void JNICALL
Java_com_devyk_ffmpeglib_config_Config_nativeFFmpegCancel(JNIEnv *env, jclass object, jlong id) {
    cancel_operation(id);
}
...
Java_com_devyk_ffmpeglib_config_Config_registerNewNativeFFmpegPipe(JNIEnv *env, jclass object,
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_devyk_ffmpeglib_config_Config_getNativeBuildDate(JNIEnv *env, jclass object) {
    char buildDate[10];
 ...
 */
JNIEXPORT int JNICALL
Java_com_devyk_ffmpeglib_config_Config_setNativeEnvironmentVariable(JNIEnv *env, jclass object,
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_devyk_ffmpeglib_config_Config_getNativeLastCommandOutput(JNIEnv *env, jclass object) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_devyk_ffmpeglib_config_Config_ignoreNativeSignal(JNIEnv *env, jclass object, jint signum) {
    if (signum == SIGQUIT) {
        handleSIGQUIT = 0;
