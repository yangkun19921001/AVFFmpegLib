...
public class FFmpegTest {
    ...
    public void mediaInformationMp3() {
        com.devyk.ffmpeglib.entity.MediaInformation mediaInformation = com.devyk.ffmpeglib.entity.MediaInformationParser.from(MEDIA_INFORMATION_MP3);
    ...
    public void mediaInformationJpg() {
        com.devyk.ffmpeglib.entity.MediaInformation mediaInformation = com.devyk.ffmpeglib.entity.MediaInformationParser.from(MEDIA_INFORMATION_JPG);
    ...
    public void mediaInformationGif() {
        com.devyk.ffmpeglib.entity.MediaInformation mediaInformation = com.devyk.ffmpeglib.entity.MediaInformationParser.from(MEDIA_INFORMATION_GIF);
    ...
    public void mediaInformationMp4() {
        com.devyk.ffmpeglib.entity.MediaInformation mediaInformation = com.devyk.ffmpeglib.entity.MediaInformationParser.from(MEDIA_INFORMATION_MP4);
    ...
    public void mediaInformationPng() {
        com.devyk.ffmpeglib.entity.MediaInformation mediaInformation = com.devyk.ffmpeglib.entity.MediaInformationParser.from(MEDIA_INFORMATION_PNG);
    ...
    public void mediaInformationOgg() {
        com.devyk.ffmpeglib.entity.MediaInformation mediaInformation = MediaInformationParser.from(MEDIA_INFORMATION_OGG);
    ...
    public void parseSimpleCommand() {
        final String[] argumentArray = com.devyk.ffmpeglib.ffmpeg.FFmpeg.parseArguments("-hide_banner -loop 1 -i file.jpg -filter_complex [0:v]setpts=PTS-STARTPTS[video] -map [video] -vsync 2 -async 1 video.mp4");
    ...
    public void parseSingleQuotesInCommand() {
        String[] argumentArray = com.devyk.ffmpeglib.ffmpeg.FFmpeg.parseArguments("-loop 1 'file one.jpg'  -filter_complex  '[0:v]setpts=PTS-STARTPTS[video]'  -map  [video]  video.mp4 ");
    ...
    public void parseDoubleQuotesInCommand() {
        ...
        argumentArray = com.devyk.ffmpeglib.ffmpeg.FFmpeg.parseArguments(" -i   file:///tmp/input.mp4 -vcodec libx264 -vf \"scale=1024:1024,pad=width=1024:height=1024:x=0:y=0:color=black\"  -acodec copy  -q:v 0  -q:a   0 video.mp4");
    ...
    public void parseDoubleQuotesAndEscapesInCommand() {
        String[] argumentArray = com.devyk.ffmpeglib.ffmpeg.FFmpeg.parseArguments("  -i   file:///tmp/input.mp4 -vf \"subtitles=file:///tmp/subtitles.srt:force_style=\'FontSize=16,PrimaryColour=&HFFFFFF&\'\" -vcodec libx264   -acodec copy  -q:v 0 -q:a  0  video.mp4");
        ...
        argumentArray = com.devyk.ffmpeglib.ffmpeg.FFmpeg.parseArguments("  -i   file:///tmp/input.mp4 -vf \"subtitles=file:///tmp/subtitles.srt:force_style=\\\"FontSize=16,PrimaryColour=&HFFFFFF&\\\"\" -vcodec libx264   -acodec copy  -q:v 0 -q:a  0  video.mp4");
    ...
    public String argumentsToString(final String[] arguments) {
        return com.devyk.ffmpeglib.ffmpeg.FFmpeg.argumentsToString(arguments);
    }

    private void assertMediaInput(com.devyk.ffmpeglib.entity.MediaInformation mediaInformation, String format, String filename) {
    ...
    private void assertTag(com.devyk.ffmpeglib.entity.MediaInformation mediaInformation, String expectedKey, String expectedValue) {
    ...
    private void assertStream(com.devyk.ffmpeglib.entity.StreamInformation streamInformation, Long index, String type, String codec, String fullCodec, String bitrate) {
    ...
    private void assertAudioStream(com.devyk.ffmpeglib.entity.StreamInformation streamInformation, Long index, String codec, String fullCodec, String sampleRate, String channelLayout, String sampleFormat, String bitrate) {
        Assert.assertEquals(index, streamInformation.getIndex());
    ...
    private void assertVideoStream(com.devyk.ffmpeglib.entity.StreamInformation streamInformation, Long index, String codec, String fullCodec, String format, Long width, Long height, String sar, String dar, String bitrate, String averageFrameRate, String realFrameRate, String timeBase, String codecTimeBase) {
        Assert.assertEquals(index, streamInformation.getIndex());
